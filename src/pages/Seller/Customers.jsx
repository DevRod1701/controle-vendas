...
import { ArrowLeft, UserPlus, Search, Users, ChevronRight } from 'lucide-react';
import { useData } from '../../contexts/DataContext';
import { useAuth } from '../../contexts/AuthContext';
import { supabase } from '../../services/supabase';
import { formatBRL } from '../../utils/formatters';
// CORREÇÃO AQUI: Adicionei as chaves { }
...
const Customers = () => {
  ...
  }, [customers, customerTransactions, search]);
  ...
  return (
    <div className="p-6 pb-24 space-y-6 animate-in fade-in font-bold">
      ...
      <div className="space-y-3">
        {customersWithBalance.length === 0 && !isCreating && <div className="text-center py-10 text-slate-400"><Users size={48} className="mx-auto mb-2 opacity-50"/><p className="text-xs font-bold uppercase">Nenhum cliente cadastrado</p></div>}
