...
import { ArrowLeft, Upload, DollarSign, Undo2, ImageIcon, AlertCircle, Loader2, Printer } from 'lucide-react'; // Adicionei Printer
import { supabase } from '../services/supabase';
import { useAuth } from '../contexts/AuthContext';
import { formatBRL } from '../utils/formatters';
import { printOrder } from '../utils/printHandler'; // Importei a função
...
const OrderDetail = ({ order, onClose, refreshData }) => {
  ...
  if (isPaying) {
    /* ... (MANTENHA O CÓDIGO DA TELA DE PAGAMENTO IGUAL AO ANTERIOR) ... */
  ...
  if (isReturning) {
    /* ... (MANTENHA O CÓDIGO DA TELA DE DEVOLUÇÃO IGUAL AO ANTERIOR) ... */
    ...
    <div className="fixed inset-0 bg-white z-[150] animate-in slide-in-from-right overflow-y-auto font-bold">
      ...
      <div className="p-6 pb-24 space-y-6">
        ...
        <div className="fixed bottom-0 left-0 right-0 p-6 bg-white border-t border-slate-100 flex flex-col gap-3">
          ...
          {/* BOTÃO DE IMPRIMIR - Só para Admin e Aprovado */}
